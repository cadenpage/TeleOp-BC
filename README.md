...
1. Simulation environment layer (`boxpush.py`, `boxpush.xml`):
...
2. Teleoperation and rollout layer (`teleop.py`):
...
- Saves rollout data to `data/*.npy`.

3. Learning and evaluation layer (`train_bc.py`, `evaluation.py`):
...
├── evaluation.py
├── environment.yaml
└── data/                # generated rollout arrays + trained checkpoints
```
